    ...
    <div className="animate-in fade-in slide-in-from-bottom-2 duration-300 pb-24 relative min-h-screen bg-black text-white font-sans">
      ...
      <div className="max-w-md mx-auto pt-8 px-4">
          ...
          <div className="text-center mb-8">
              ...
              {showEventBanner && (
                  <div className="mt-4 bg-gradient-to-r from-amber-500/20 to-orange-500/20 border border-amber-500/30 p-3 rounded-xl animate-pulse">
                      <p className="text-amber-400 font-bold text-sm">🔥 {event.eventName} 🔥</p>
                      <p className="text-amber-200 text-xs">Extra {isSubscribed ? (event.renewalDiscountPercent || event.discountPercent) : event.discountPercent}% OFF for you!</p>
                  </div>
              )}
          </div>
